...
//			}
			...
			viewHolder.imageViewWalkType.setImageResource(RunType.ID2Image(list.get(position).listInfo.getSporttype()));
			if(!date.equals("0"))
				viewHolder.textview_map_history_time.setText(arr[1].substring(0, 5));
...
//>>>>>>> .r2858
	...
	private void adapterFindViews(View view) {
		viewHolder.textview_map_history_date = (TextView) view.findViewById(R.id.textview_map_history_date);
		...
		viewHolder.textview_runtype = (TextView) view.findViewById(R.id.textview_runtype);
		viewHolder.rl_date = (RelativeLayout) view.findViewById(R.id.rl_date);
		viewHolder.bg = (LinearLayout) view.findViewById(R.id.linearlayout_null);
