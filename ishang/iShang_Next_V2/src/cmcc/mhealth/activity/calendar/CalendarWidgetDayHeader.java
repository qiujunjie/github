 ...
 * @Version V1.0
 */
public class CalendarWidgetDayHeader extends View {
	// 字体大小
	...
	public CalendarWidgetDayHeader(Context context, int iWidth, int iHeight) {
		super(context);
	...
	private void drawDayHeader(Canvas canvas) {
		// 画矩形，并设置矩形画笔的颜色
		pt.setColor(MyCalendarActivity.Calendar_WeekBgColor);		
		...
		pt.setColor(MyCalendarActivity.Calendar_WeekFontColor);
		
		// draw day name
		final String sDayName = CalendarDayStyle.getWeekDayName(iWeekDay);
