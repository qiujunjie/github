...
public class ScoreBarView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(Color.rgb(245, 186, 4));// 设置中间图块颜色 f6ba04
		...
		canvas.drawBitmap(setScale(mRunPic, rightScale), (Bl1 + Bl2) * Width + mLeftPic.getWidth() * leftScale, 0, paint);// 画小人图片
